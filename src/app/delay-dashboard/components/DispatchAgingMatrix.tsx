...
import type { MatrixRow } from "../lib/dispatchAggregate";
...
/** Dispatch Report's own copy of the Report tab's AgingMatrix — same
 *  markup, but typed against dispatch's own MatrixRow (six categories,
 *  not six departments), so duplicated rather than shared. */
export default function DispatchAgingMatrix({ columns, rows, legend, onCellClick, onTotalClick }: Props) {
  return (
